<template>
    <transition name="fade">
        <div v-show="isModalOpen" :class="backdropClasses" @click="hideModal">
            <div class="mx-auto my-auto min-w-[360px] rounded-lg bg-slate-100 p-4 lg:w-1/3"
                :class="[placementClass, 'absolute']" @click.stop>
                <!-- Modal Header Slot -->
...
const props = defineProps({
    backdropClasses: {
        type: String,
        default: 'bg-slate-700 bg-opacity-75 fixed inset-0 z-50'
    },
    placement: {
        type: String,
        default: 'center'
